...
import { dictionaryRelationTypeEnum, kanjiRelationTypeEnum, } from "./enums.js";
 ...
 */
export const dictionaryEntryLinks = pgTable("dictionary_entry_links", {
    ...
    check("dictionary_entry_links_no_self_check", sql `${table.sourceEntryId} <> ${table.targetEntryId}`),
]);
...
export const dictionaryGrammarLinks = pgTable("dictionary_grammar_links", {
    dictionaryEntryId: uuid("dictionary_entry_id")
        .notNull()
        .references(() => dictionaryEntries.id, { onDelete: "cascade" }),
    grammarPatternId: uuid("grammar_pattern_id")
...
export const dictionaryKanjiLinks = pgTable("dictionary_kanji_links", {
    dictionaryEntryId: uuid("dictionary_entry_id")
        .notNull()
        .references(() => dictionaryEntries.id, { onDelete: "cascade" }),
    ...
    check("dictionary_kanji_example_rank_check", sql `${table.exampleRank} IS NULL OR ${table.exampleRank} BETWEEN 1 AND 5`),
]);
export const grammarPatternLinks = pgTable("grammar_pattern_links", {
    ...
    check("grammar_pattern_links_no_self_check", sql `${table.sourcePatternId} <> ${table.targetPatternId}`),
]);
export const kanjiEntryLinks = pgTable("kanji_entry_links", {
    ...
    check("kanji_entry_links_no_self_check", sql `${table.sourceKanjiId} <> ${table.targetKanjiId}`),
]);
export const questionVocabularyLinks = pgTable("question_vocabulary_links", {
...
export const questionGrammarLinks = pgTable("question_grammar_links", {
    questionId: uuid("question_id")
        .notNull()
        .references(() => questions.id, { onDelete: "cascade" }),
    grammarPatternId: uuid("grammar_pattern_id")
...
export const dictionaryEntryLinksRelations = relations(dictionaryEntryLinks, ({ one }) => ({
...
export const sentenceVocabularyLinksRelations = relations(sentenceVocabularyLinks, ({ one }) => ({
...
export const sentenceGrammarLinksRelations = relations(sentenceGrammarLinks, ({ one }) => ({
    sentence: one(sentences, {
...
export const dictionaryGrammarLinksRelations = relations(dictionaryGrammarLinks, ({ one }) => ({
    dictionaryEntry: one(dictionaryEntries, {
...
export const dictionaryKanjiLinksRelations = relations(dictionaryKanjiLinks, ({ one }) => ({
    dictionaryEntry: one(dictionaryEntries, {
...
export const grammarPatternLinksRelations = relations(grammarPatternLinks, ({ one }) => ({
...
export const questionVocabularyLinksRelations = relations(questionVocabularyLinks, ({ one }) => ({
...
export const questionGrammarLinksRelations = relations(questionGrammarLinks, ({ one }) => ({
    question: one(questions, {
