...
export const mediaAssets = pgTable("media_assets", {
    ...
    index("media_assets_related_item_idx").on(table.relatedItemType, table.relatedItemId),
    ...
    check("media_assets_storage_path_not_blank_check", sql `btrim(${table.storagePath}) <> ''`),
    ...
    check("media_assets_related_pair_check", sql `(${table.relatedItemType} IS NULL) = (${table.relatedItemId} IS NULL)`),
